// F4 — emit Takaro `entity-killed` when a player kills an animal.
//
...
modded class AnimalBase
{
    ...
    override void EEKilled(Object killer)
    {
        ...
        TakaroLog.Debug("AnimalBase.EEKilled " + GetType() + " killer=" + killerType + " lastSource=" + srcType + " ammo=" + m_TakaroLastAmmo);
